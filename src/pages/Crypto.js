...
export default function Crypto() {
    return (
        <div className="page-crypto">
            ...
            <main>
                    <img src={crypto1} alt="Web3 Crypto App" className="header-image" />
                    <h2>  [Home Page]  </h2>
                    <p>Web3 crypto app that allows users to send and log crypto transactions.</p>

                    <img src={crypto2} alt="Dashboard" className="header-image" />
                    <h2>  [Dashboard]   </h2>
                    <p>Pulls logged-in user's transactions from the MERN database.</p>

                    <img src={mongoDB} alt="MongoDB" className="header-image" />
                    <h2>    [MongoDB]   </h2>
